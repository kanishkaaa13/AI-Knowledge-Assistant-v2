"""
Test write path through actual API endpoint - using correct /upload endpoint
"""
...
# Step 2: Upload the PDF via /upload endpoint
if headers:
    print("Step 2: Upload PDF via /documents/upload endpoint (60s timeout)")
    files = {
