"""
Test write path through actual API endpoint - with longer timeout
"""
...
# Step 2: Upload the PDF with longer timeout
if headers:
    print("Step 2: Upload PDF via /documents endpoint (60s timeout)")
    files = {
