"""
Test write path through actual API endpoint - using 127.0.0.1
"""
...
# Upload the PDF (try without auth first for testing)
print("Step 1: Upload PDF via /documents endpoint")
files = {
...
if file_path:
    print("Step 2: Read raw bytes from disk to confirm encryption")
    try:
    ...
    print("Step 2: Skipped (upload failed)")
